...
def read_data_sets(fake_data=False, one_hot=False, dtype=dtypes.float32, reshape=True, validation_size=VALIDATION_SIZE):
  ...
  batch1=unpickle('apples-batches-py/data_batch_1')
  batch2=unpickle('apples-batches-py/data_batch_2')
  batch3=unpickle('apples-batches-py/data_batch_3')
  batch4=unpickle('apples-batches-py/data_batch_4')
  batch5=unpickle('apples-batches-py/data_batch_5')
  ...
  test_batch=unpickle('apples-batches-py/test_batch')
  ...
  train_labels=np.zeros((NUM_TRAIN_EXAMPLES,NUM_OUTPUTS),dtype=np.float32)
  test_labels=np.zeros((NUM_TRAIN_EXAMPLES,NUM_OUTPUTS),dtype=np.float32)
